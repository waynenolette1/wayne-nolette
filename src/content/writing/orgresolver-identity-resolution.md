...
- "How are **we** doing on monitor governance?" — who is "we"?
...
Without OrgResolver, the AI agent would require users to specify exact service IDs and team names in every query — turning a natural language interface into a structured form.
