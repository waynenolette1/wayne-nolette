...
**Existing ecosystem.** ZoomInfo already uses BigQuery extensively. IAM policies, networking, and monitoring are already configured. The AI agent's governed tools can query BigQuery directly using the same patterns as other internal systems.
...
- Dataset-level IAM provides strong isolation between governance domains
